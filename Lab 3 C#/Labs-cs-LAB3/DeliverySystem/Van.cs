...
namespace DeliverySystem
{
    public class Van : Car
    {
        ...
        public Van(string brand, int year, double mileage, int doors, double capacity)
        ...
        {
            return "Van: " + brand + " (" + year + "), Doors: " + doors +
                   ", Load: " + currentLoad + "/" + loadCapacity + "kg, Fuel: " + fuelLevel + "L";
        }
